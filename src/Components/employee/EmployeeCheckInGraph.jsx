...
const EmployeeCheckInGraph = () => {
  ...
  return (
    <div className="bg-purple-100 w-full rounded-lg shadow-md p-2">
      <h2 className="text-xl font-bold mb-1">My Check In Trends</h2>
      <LineChart width={1300} height={225} data={data}>
        <XAxis dataKey="date" />
        <YAxis />
...
export default EmployeeCheckInGraph;
